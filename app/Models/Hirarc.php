...
class Hirarc extends Model
{
    ...
    {
        return $this->hasMany(HirarcWorkUnit::class);
    }

    public function chemicals()
    {
        return $this->hasMany(HirarcChemical::class);
    }

    public function recommendations()
    {
        return $this->hasMany(HirarcRecommendation::class);
    }

    public function deleteRequests()
    {
        return $this->hasMany(
            \App\Models\HirarcDeleteRequest::class,
            'hirarc_id',
            'id'
        );
    }
    ...
    public function riskEvaluations()
    {
        return $this->hasManyThrough(
            HirarcRiskEvaluation::class,
            HirarcExposure::class,
            'hirarc_id',
            'hirarc_exposure_id'
        );
    }
    ...
    public function timeline(): array
    {
        ...
        $push('HIRARC created', $this->created_at, $this->assessor_name, 'created');
